...
public class GestionProveedores extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        TablaProveedores.setGridColor(new java.awt.Color(153, 204, 255));
        TablaProveedores.setRowHeight(25);
    ...
    private void EditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditarMouseClicked
        if (datoSeleccionado >= 0) {
            ...
            Proveedor.Ced.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 0)));
            Proveedor.Nombres.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 1)));
            Proveedor.Apellidos.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 2)));
            Proveedor.direc.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 3)));
            Proveedor.Telefono.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 4)));
            Proveedor.Correo.setText(String.valueOf(TablaProveedores.getValueAt(datoSeleccionado, 5)));
            Proveedor.Ced.enable(false);
            Proveedor.Guardar.setVisible(false);
            Proveedor.Actualizar.setVisible(true);
