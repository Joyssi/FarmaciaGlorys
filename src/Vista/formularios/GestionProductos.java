...
public class GestionProductos extends javax.swing.JInternalFrame {
    ...
    private void AgregarProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarProductoMouseClicked
        if (datoSeleccionado >= 0) {
            ...
            Ventas.codProducto.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 0)));
            Ventas.NombreProducto.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 1)));
            Ventas.Precio.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 4)));
            Ventas.Stock.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 3)));
            Ventas.marca.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 6)));
            Ventas.Presentacion.setText(String.valueOf(TablaProductos.getValueAt(datoSeleccionado, 8)));
            dispose();
        } else {
