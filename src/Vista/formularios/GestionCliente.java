...
public class GestionCliente extends javax.swing.JPanel {
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(Buscar, javax.swing.GroupLayout.DEFAULT_SIZE, 553, Short.MAX_VALUE)))
    ...
    private void EditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditarMouseClicked
     ...
     Main.mainForm.repaint();
            Cliente.Ced.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 0)));
            Cliente.Nombres.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 1)));
            Cliente.Apellidos.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 2)));
            Cliente.direc.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 3)));
            Cliente.Telefono.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 4)));
            Cliente.Correo.setText(String.valueOf(TablaClientes.getValueAt(datoSeleccionado, 5)));
            Cliente.Ced.enable(false);
            Cliente.Guardar.setVisible(false);
            Cliente.Actualizar.setVisible(true);
            cli.setVisible(true);
        } else {
