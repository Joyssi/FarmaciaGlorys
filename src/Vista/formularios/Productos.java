...
public class Productos extends javax.swing.JInternalFrame {
    ...
    public void mostrar() {
        try {
            ...
            Gestion.TablaProductos.setModel(modelo);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(Vencimiento, javax.swing.GroupLayout.PREFERRED_SIZE, 330, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(79, 79, 79)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(Marca, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addComponent(jSeparator6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 437, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void MarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MarcaMouseClicked
        ...
        int x = (Main.desktopPane.getWidth() / 2) - marca.getWidth() / 2;
        int y = ((Main.desktopPane.getHeight() / 2) - marca.getHeight() / 2) - 10;
        marca.setLocation(x, y);
        Main.desktopPane.add(marca);
        marca.toFront();
    ...
    private void CategoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CategoriaMouseClicked
        ...
        int x = (Main.desktopPane.getWidth() / 2) - cate.getWidth() / 2;
        int y = ((Main.desktopPane.getHeight() / 2) - cate.getHeight() / 2) - 10;
        cate.setLocation(x, y);
        Main.desktopPane.add(cate);
        cate.toFront();
    ...
    private void PresentacionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PresentacionMouseClicked
        ...
        int x = (Main.desktopPane.getWidth() / 2) - pre.getWidth() / 2;
        int y = ((Main.desktopPane.getHeight() / 2) - pre.getHeight() / 2) - 10;
        pre.setLocation(x, y);
        Main.desktopPane.add(pre);
        pre.toFront();
        pre.setVisible(true);
